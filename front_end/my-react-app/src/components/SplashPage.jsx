    ...
    return (
        <Container fluid className="splash-page text-center">
            ...
            <div className="buttons">
                <Button variant="primary" size="lg" className="my-2" onClick={handleLoginClick}>Log In</Button>
                <Button variant="secondary" size="lg" className="my-2" onClick={handleSignupClick}>Sign Up</Button>
            </div>
        </Container>
    )
}
